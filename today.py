...
USER_NAME = os.environ['USER_NAME'] # 'schrodingerspet'
...
def loc_counter_one_repo(owner, repo_name, data, cache_comment, history, addition_total, deletion_total, my_commits):
    """
    Recursively call recursive_loc only adds the LOC value of commits authored by me
    """
...
if __name__ == '__main__':
    """
    Aditya Akolkar (schrodingerspet), 2025
    """
